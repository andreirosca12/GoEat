...
import logo from './assets/klausenLogo.jpg'; // Importă imaginea logo-ului
import backgroundImage from './assets/klausen.jpg'; // Importă imaginea de fundal

Modal.setAppElement('#root'); // Setează elementul principal al aplicației pentru accesibilitate

function RestaurantPageKlausen() {
  ...
  return (
    <div className="restaurant-page">
      <div className="header">
        <img src={backgroundImage} alt="Restaurant" className="background-image" style={{ width: '1500px', height: '770px' }} />
        <img src={logo} alt="Logo" className="logo" />
        <div className="restaurant-name-box">
          <h1 className="restaurant-name">Klausen Burger Brewery</h1>
        </div>
      </div>
...
export default RestaurantPageKlausen;