...
import logo from './assets/ginzaLogo.png'; // Importă imaginea logo-ului
import backgroundImage from './assets/ginza.jpg'; // Importă imaginea de fundal
  ...
  return (
    <div className="restaurant-page">
      <div className="header">
        <img src={backgroundImage} alt="Restaurant" className="background-image" style={{width: '1500', height: '770'}}/>
        <img src={logo} alt="Logo" className="logo" />
        <div className="restaurant-name-box">
          <h1 className="restaurant-name">Ginza Sushi</h1>
        </div>
      </div>
