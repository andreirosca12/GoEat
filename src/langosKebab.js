...
import logo from "./assets/langosLogo.png"; // Importă imaginea logo-ului
import backgroundImage from "./assets/langos.jpg"; // Importă imaginea de fundal

Modal.setAppElement("#root"); // Setează elementul principal al aplicației pentru accesibilitate

function LangosKebab() {
    ...
    <div className="restaurant-page">
      <div className="header">
        <img
          ...
          style={{ width: "1500px", height: "770px" }}
        />
        <img src={logo} alt="Logo" className="logo" />
        <div className="restaurant-name-box">
          <h1 className="restaurant-name">Langos & Kebab</h1>
        </div>
      </div>
